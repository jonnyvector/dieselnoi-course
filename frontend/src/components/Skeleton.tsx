...
export function CourseCardSkeleton() {
  return (
    <div className="bg-white dark:bg-dark-card rounded-lg shadow-card dark:shadow-card-md overflow-hidden">
  ...
  return (
    <div className="space-y-3">
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="flex items-center gap-4 p-4 bg-white dark:bg-dark-bg rounded-lg border border-gray-200 dark:border-gray-700"
        >
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="bg-white dark:bg-dark-card rounded-lg shadow-card dark:shadow-card p-6">
            <Skeleton className="h-6 w-3/4 mb-3" />
            <Skeleton className="h-4 w-full mb-2" />
