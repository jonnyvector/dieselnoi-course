...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-dark-bg">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-purple-900 via-purple-800 to-black dark:from-purple dark:via-purple-900 dark:to-black text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <div className="inline-block mb-4 px-4 py-2 bg-gold text-purple-900 rounded-full text-sm font-bold">
                🏆 Train with a Legend
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl mb-6 leading-tight text-white">
                Master <span className="text-gold">Golden Era</span> Muay Thai
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                {user ? (
                  <Link
                    href="/dashboard"
                    className="px-8 py-4 bg-gold text-purple-900 font-bold rounded-lg text-lg hover:bg-gold/90 transition-all transform hover:scale-105 shadow-lg"
                  >
                    Go to Dashboard →
                  </Link>
                ) : (
            ...
            <div className="relative">
              <div className="aspect-video bg-black/30 backdrop-blur-sm rounded-2xl overflow-hidden shadow-2xl border-4 border-gold/30">
                <div className="absolute inset-0 flex items-center justify-center">
                  <button className="w-20 h-20 bg-gold rounded-full flex items-center justify-center hover:bg-gold/90 transition-all transform hover:scale-110 shadow-lg">
      ...
      {/* Trust Bar */}
      <section className="bg-gray-900 dark:bg-dark-bg py-6 border-y border-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-purple-100 dark:bg-purple/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-purple dark:text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 bg-white dark:bg-dark-bg">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            ...
            <a href="#" className="text-gold dark:text-gold font-semibold hover:text-gold-dark dark:hover:text-gold/80 transition-colors">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-purple-900 via-purple-800 to-black dark:from-purple dark:to-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/signup"
            className="inline-block px-10 py-5 bg-gold text-purple-900 font-bold rounded-lg text-xl hover:bg-gold/90 transition-all transform hover:scale-105 shadow-2xl"
          >
      ...
      {/* Footer */}
      <footer className="bg-gray-900 dark:bg-dark-bg text-gray-400 py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/" className="hover:text-gold transition-colors">Browse Courses</Link></li>
