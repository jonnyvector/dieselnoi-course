                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                      ...
                      <div className="hidden sm:block flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          {!lesson.video_url && !lesson.mux_playback_id && !lesson.is_free_preview && !isLessonLocked(lesson) && !lesson.unlock_date && (
                            <span className="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300 text-xs font-semibold rounded flex items-center gap-1">
                              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                              </svg>
                              LOCKED
