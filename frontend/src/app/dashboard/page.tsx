          ...
          <div className="bg-gradient-to-br from-purple-50 to-yellow-50 dark:from-dark-bg dark:to-dark-bg rounded-lg shadow mb-8 overflow-hidden border border-[#5f4891]/30 dark:border-gray-700">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 bg-white dark:bg-[#5f4891]/10 border border-gray-300 dark:border-[#5f4891]/40 rounded-lg text-gray-900 dark:text-gray-100 text-sm font-mono"
                  />
                  <button
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-[#5f4891] hover:bg-purple-700 dark:bg-dark-button dark:hover:opacity-90 text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-white dark:bg-[#5f4891]/10 rounded-lg p-4 text-center border border-gray-200 dark:border-[#5f4891]/40">
